...
public class ReservationController {
  ...
  public BookingResponseRest<ReservationRest> getReservationById(@PathVariable Long reservationId)
    throws BookingException {
    return BookingResponseRest
      .<ReservationRest>builder()
      .status("Success")
      .message("OK")
  ...
  public BookingResponseRest<String> createReservation(@RequestBody CreateReservationRest createReservationRest)
    throws BookingException {
    return BookingResponseRest
      .<String>builder()
      .status("Success")
